...
INLINE static int rt_write_particles(const struct part* parts,
  ...
  list[4] = io_make_output_field("RTDebugCallsIactTransport", INT, 1,
  ...
  list[11] = io_make_output_field("RTDebugStarsInjectPrepTotCounts", ULONGLONG, 1, UNIT_CONV_NO_UNITS, 0, parts, 
