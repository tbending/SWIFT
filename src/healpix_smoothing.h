...
double healpix_smoothing_get_max_pixrad(
    struct healpix_smoothing_info *smooth_info);

void healpix_smoothing_get_pixel_range(
    struct healpix_smoothing_info *smooth_info, const double theta,
    const double phi, const double radius, size_t *first_pixel,
    size_t *last_pixel);

void healpix_smoothing_find_neighbours(
    struct healpix_smoothing_info *smooth_info, const double theta,
